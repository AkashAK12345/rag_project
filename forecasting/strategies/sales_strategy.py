"""
forecasting/strategies/sales_strategy.py
"""
...
class SalesForecastStrategy(ForecastStrategy):
    def forecast(self, request: ForecastRequest) -> ForecastResult:
        series = extract_numeric_series(request.observations, ["total_sales", "sales", "sales_amount"])
        if len(series) < 3:
