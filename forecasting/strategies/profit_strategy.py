"""
forecasting/strategies/profit_strategy.py
"""
...
class ProfitForecastStrategy(ForecastStrategy):
    def forecast(self, request: ForecastRequest) -> ForecastResult:
        series = extract_numeric_series(request.observations, ["net_profit", "profit", "profit_margin"])
        if len(series) < 3:
...
ForecastStrategyRegistry.register(ForecastMetric.PROFIT, ProfitForecastStrategy)
