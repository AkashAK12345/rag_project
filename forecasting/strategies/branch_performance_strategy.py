"""
forecasting/strategies/branch_performance_strategy.py
"""
...
class BranchPerformanceForecastStrategy(ForecastStrategy):
    def forecast(self, request: ForecastRequest) -> ForecastResult:
        series = extract_numeric_series(request.observations, ["performance_score", "branch_score", "score"])
        if len(series) < 3:
...
ForecastStrategyRegistry.register(ForecastMetric.BRANCH_PERFORMANCE, BranchPerformanceForecastStrategy)
